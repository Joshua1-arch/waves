    ...
    <PageTransition>
      <section className="section-shell section-space pt-28 text-center">
        ...
        <h1 className="mx-auto mt-6 max-w-3xl font-serif text-3xl leading-snug md:text-5xl">
          True luxury is found in the{" "}
          <em className="text-brand-gold">architectural silence</em> between
          form and function.
        </h1>
      </section>
      ...
      <section className="section-shell pb-20">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <motion.div {...SCROLL_REVEAL}>
            ...
            <h2 className="mt-4 font-serif text-4xl">Wells</h2>
            <div className="mt-6 space-y-4 text-sm leading-relaxed text-brand-black/70">
              <p>
                Wave & Co. was born from a simple conviction: eyewear should be
                treated with the same rigour as architecture. Every line, hinge,
                and material choice must earn its place.
              </p>
              <p>
                In 2014, we rejected the noise of fast fashion in favour of
                quiet luxury — frames designed to be worn for decades, not
                seasons.
              </p>
              <p>
      ...
      <section className="section-shell section-space border-t border-brand-border">
        ...
        <div className="relative mx-auto mt-16 max-w-4xl">
          ...
          {timeline.map((item) => (
            <motion.div
              key={item.year}
              className="mb-20 grid gap-8 md:grid-cols-2 md:items-center"
              {...SCROLL_REVEAL}
            >
              {item.imageLeft ? (
                <>
      ...
      <section className="section-shell pb-28">
        <div className="mx-auto max-w-lg border border-brand-border bg-brand-white p-10 text-center">
