...
export function ContactPageClient({ content }: ContactPageClientProps) {
  return (
    <PageTransition>
      <div className="section-shell section-space pt-28 overflow-x-hidden">
        <div className="grid gap-16 lg:grid-cols-2">
          <motion.div {...SCROLL_REVEAL}>
            ...
            <dl className="mt-10 space-y-6 break-words">
              <div>
                <dt className="text-[10px] uppercase tracking-widest">Email</dt>
                <dd className="mt-1 text-sm break-all sm:break-normal">{content.email}</dd>
              </div>
              <div>
                <dt className="text-[10px] uppercase tracking-widest">
                  Flagship Studio
                </dt>
                <dd className="mt-1 whitespace-pre-line text-sm">{content.address}</dd>
              </div>
              <div>
                <dt className="text-[10px] uppercase tracking-widest">Phone</dt>
                <dd className="mt-1 text-sm">{content.phone}</dd>
              </div>
            </dl>
          </motion.div>

          <motion.div
            className="border border-brand-border bg-brand-white/60 p-6 sm:p-8"
            {...SCROLL_REVEAL}
          >
      ...
      <section className="relative h-[45vh] min-h-[320px] overflow-hidden sm:h-[50vh]">
        <Image
          ...
          sizes="100vw"
        />
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-brand-black/30 px-6 text-center">
          ...
          <div className="max-w-xs bg-brand-white px-6 py-4 sm:max-w-none sm:px-8 text-center">
            <p className="text-xs font-medium uppercase tracking-widest">
              Visit Our Atelier
            </p>
            <p className="mt-1 text-xs leading-relaxed text-brand-black/60">{content.hours}</p>
          </div>
        </div>
      </section>

      <section className="section-shell py-20 text-center">
        <blockquote className="mx-auto max-w-2xl font-serif text-xl italic leading-relaxed sm:text-2xl md:text-3xl">
